---
title: "What is MRR? How to calculate & increase your monthly recurring revenue"
description: "A deep dive on why you can't afford to miscalculate your MRR, covering why MRR is important, mistakes to avoid, and ways to keep your MRR on track. Includes MRR formula."
source: "resources/monthly-recurring-revenue.html"
---

# What is MRR? How to calculate & increase your monthly recurring revenue
...
Every business is interested in how much revenue they generate each month, but not all businesses have a recurring revenue model. What is monthly recurring revenue (MRR), and why is it so important to SaaS businesses?
  ...
  * [What is recurring revenue?](#recurring-revenue)
  * [What is MRR?](#what-is-mrr)
  * [Why tracking MRR is important](#Why)
  * [How to calculate MRR](#How)
  * [Common mistakes calculating MMR](#common-mistakes)
  * [Five types of MRR](#five-types)
  * [How to use MRR calculations](#why-calculate)
  * [What is a good MRR rate?](#good-rate)
  * [Metrics to use with MRR](#other-metrics)
  * [What MRR doesn’t measure](#What-MRR-doesn’t-measure)
  * [Ways to grow your MRR](#ways-to-grow-mrr)
  * [MRR FAQs](#mrr-faqs)
  * [MRR-related metrics](#MRR-related-metrics)


Share

[](https://x.com/intent/tweet?text=What%20is%20MRR%3F%20Calculate%20%26%20increase%20your%20monthly%20recurring%20revenue%20-%20https%3A%2F%2Fwww.paddle.com%2Fresources%2Fmonthly-recurring-revenue%20via%20%40paddlehq)[](https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fwww.paddle.com%2Fresources%2Fmonthly-recurring-revenue)[](https://www.linkedin.com/shareArticle?mini=true&url=https%3A%2F%2Fwww.paddle.com%2Fresources%2Fmonthly-recurring-revenue&title=What%20is%20MRR%3F%20Calculate%20%26%20increase%20your%20monthly%20recurring%20revenue&source=)
...
Monthly Recurring Revenue (MRR) is the income that a company expects to receive in payments on a monthly basis. MRR is a critical revenue metric that helps subscription companies to understand their overall business health profitability by keeping a close eye on monthly [cash flow](/resources/cash-flow).

Related[![](https://images.prismic.io/paddle/88a3d189-d4d5-47cd-8285-2ef55b57eec5_Platform-Subscriptions-main.png?auto=format%2Ccompress&fit=max&w=1080)More than reporting: How to draw (and use) meaningful insights from SaaS metrics](/blog/how-to-draw-and-use-meaningful-insights-from-saas-metrics)
...
In the [SaaS business model](/resources/saas-business-model), you’re able to make accurate [financial projections](https://www.paddle.com/blog/cash-flow-forecasting) because of the subscriptions, and a large part of that is because monthly recurring revenue is relatively consistent and predictable. As you gain subsequent months of consistent revenue, you can begin to model estimates of where you’ll be and then can [plan your business](https://www.paddle.com/blog/revenue-report) accordingly.
...
The simple way to calculate MRR is to take your [Average Revenue per User (ARPU)](/resources/average-revenue-per-user) on a monthly basis and then multiply it by the total number of users in a given month. 
...
Related[![](https://images.prismic.io/paddle/1360dc21-c75b-4280-a7c9-30a52c087139_abstract-sand+timer.png?auto=format%2Ccompress&fit=max&w=1080)How to calculate retention rate: Formula + top 4 mistakes to avoid](/resources/calculate-retention-rate)

###  _3\. Breakdown by cohort_
...
Admittedly, this can and should get much more complicated as you start to dig into your key metrics more. You’ll want to measure your expansion MRR (upgrades), [customer churn,](/resources/customer-churn-analysis) downgrades, new, etc. as below:
...
Related[![](https://images.prismic.io/paddle/4e346960-3dcb-48f0-8958-a2e5e1fc118c_abstract-paddle-merchant+of+record.png?auto=format%2Ccompress&fit=max&w=1080)5-step revenue recognition process for subscription businesses](/resources/saas-revenue-recognition)
...
Additionally, including transaction fees doesn’t give you enough credit and hides a potential room for optimization. Sure, you’ll never get that transaction fee to 0%, but you can easily switch your [automated billing software](https://www.paddle.com/billing), spin up your own solution, etc., to optimize costs. A great concept to keep in mind is that any expense that can be optimized should be labeled as an expense and not immediately taken out of your MRR. With that logic, you should theoretically take out all of your [customer acquisition cost (CAC)](/resources/guide-to-customer-acquisition-cost).
...
Like many other [SaaS metrics](https://www.paddle.com/glossary/saas-metrics), MRR has variations depending on the insights you're after. These can be expressed as actual financial numbers, or as percentages (compared to the month before) to show rates of growth or decline.

  1. **New MRR:** The MRR from only your new subscribers. When put against **[Customer Acquisition Cost (CAC)](/resources/guide-to-customer-acquisition-cost)** it will show the profitability of your new subscribers.
  2. **Expansion MRR:** The additional MRR generated from existing subscribers, usually as a result of an upgrade or renewal at a higher price. Typically this does not include subscribers who converted from a free trial, as these would be counted as new MRR.
  3. **Reactivation MRR:** The monthly revenue earned from previously churned or canceled subscriptions that are reactivated during the month.
  4. **Contraction MRR** : The total reduction in MRR due to downgrades and subscription cancellations compared to the previous month. When expressed as a percentage, this is known as ‘Churn MRR’. 
  5. **Net MRR:** The combination of New, Expansion, Reactivation, and Contraction MRR. This gives an overall picture of how MRR is changing. MRR often begins with Net MRR, before digging into its constituent parts. When expressed as a percentage, this is known as ‘**[Net Revenue Retention](/blog/net-revenue-retention-the-new-benchmark-metric-for-saas)** ’. 


Related[![](https://images.prismic.io/paddle/fedeb6f7-b6df-40da-9795-6998ddc64d22_abstract-filler+5.png?auto=format%2Ccompress&fit=max&w=1080)7-step guide to financial forecasting & planning for any business](/resources/financial-forecasting)

## **How to use MRR calculations to grow?**

If your business follows a recurring revenue model of profitability, then calculating MRR (along with similar SaaS metrics like [annual recurring revenue, or ARR](https://www.paddle.com/resources/annual-recurring-revenue)) will help you understand the health of your company, set goals for the future, and determine how you'll reach those goals. Understanding MRR is important because it gives you insights into:

### 

### Product-market fit compass metric

After finding the initial product-market fit through user testing and activity, you can measure monthly recurring revenue as the[ main compass metric to track growth](https://www.paddle.com/resources/compass-saas-metric) within a SaaS organization. This is because MRR is the purest measure of your revenue in a SaaS business, indicating with a high degree of certainty how your future revenue will change over time.

### 

### Product team

Building a better product will improve customer retention rate, which will prevent MRR loss. Every month your team should be incentivised by MRR to develop features and experiences to prevent [MRR Churn](/resources/mrr-churn).
...
Related[![](https://images.prismic.io/paddle/ae175005-3758-4afe-810f-41922eb368b2_abstract-growth.png?auto=format%2Ccompress&fit=max&w=1080)Guide to compound annual growth rate: CAGR formula, benefits & limitations](/resources/compound-annual-growth-rate)
...
Another consideration for calculating MRR is when in the month you [recognize the revenue](/resources/revenue-recognition-examples). For annual or multi-year subscriptions where revenue is being recognized monthly, a SaaS business has control over what day that happens. But where customers pay on a monthly basis, the billing date is normally determined by when the customer took out the contract. So revenue will be recognized all through the month, meaning your MRR will fluctuate depending on what day you assess it. 
...
Make it easy for your subscribers to access the next level of service. Introducing **[tiered packages](https://www.paddle.com/blog/the-tiered-pricing-model)** \- where your customers pay incrementally to access more of your service, or **[usage-based pricing](https://www.paddle.com/blog/saas-usage-billing-done-well)** based on the number of users and how much they are consuming - creates a scalable revenue model.

Related[![](https://images.prismic.io/paddle/cb9e9c1e-6dd9-4f92-b4ff-1262eb27f639_Illustration_Generic_SingleSourceofTruth_blue_bg.jpg?auto=format%2Ccompress&fit=max&w=1080)7 SaaS growth strategies to thrive in the age of AI](/resources/growth-strategies-for-saas)
...
P.S: Paddle's API-friendly [SaaS billing software](https://www.paddle.com/solutions/saas-billing) measures MRR accurately so you can get the most accurate pulse on your business. [Sign up here.](https://login.paddle.com/signup)