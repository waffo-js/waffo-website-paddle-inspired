---
title: "Customer lifetime value (CLV) explained: Formula + strategies for improving"
description: "Customer lifetime value is an essential metric for understanding the performance and potential of a SaaS business. There’s more than one way to calculate LTV—here’s how we do it, and why."
source: "resources/customer-lifetime-value.html"
---
...
Customer lifetime value (CLV) is an essential metric for understanding the performance and potential of a SaaS business. There’s more than one way to calculate CLV—here’s how we do it, and why, plus everything you need to know about the metric.
  ...
  * [What is CLV](#Wha-tis-ltv)
  * [Why is CLV important?](#why-clv-isimportant)
  * [How to calculate CLV](#calculate-clv)
  * [Traditional CLV calculations](#traditional)
  * [Drawbacks of these methods](#drawback)
  * [How we calculate CLV](#how-we-calculate)
  * [How CLV influences CAC](#clv-and-cac)
  * [What affects CLV?](#what-affects-CLV)
  * [CLV benchmarks](#benchmarks)
  * [Factors influencing CLV](#Factors influencing CLV)
  * [CLV + other metrics](#other-metrics)
  * [How to increase CLV](#How to increase CLV)
  * [CLV FAQs](#faqs)


Share

[](https://x.com/intent/tweet?text=Customer%20lifetime%20value%3A%20Calculation%2C%20formula%20%26%20SaaS%20business%20strategies%20for%20improving%20-%20https%3A%2F%2Fwww.paddle.com%2Fresources%2Fcustomer-lifetime-value%20via%20%40paddlehq)[](https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fwww.paddle.com%2Fresources%2Fcustomer-lifetime-value)[](https://www.linkedin.com/shareArticle?mini=true&url=https%3A%2F%2Fwww.paddle.com%2Fresources%2Fcustomer-lifetime-value&title=Customer%20lifetime%20value%3A%20Calculation%2C%20formula%20%26%20SaaS%20business%20strategies%20for%20improving&source=)
...
When you’re considering the direction your company is taking, the lifetime value (LTV) of a user is one of the [most important metrics](/glossary/saas-metrics) to understand. Different [LTV models](https://www.paddle.com/resources/ltv-cac-model) can inform decisions like how much you can pay to acquire a customer, the effects of losing users, and how changes to a product affect the sum-total revenue you can expect to bring in.
...
[**Use this quick factsheet to stay on top of CLV in your business** →](https://info.paddle.com/hubfs/Customer%20Lifetime%20Value%20CLV%20Factsheet.pdf)

Despite the importance of customer lifetime value, many companies still overlook its significance. According to a 2019 **[report from Criteo](https://www.criteo.com/wp-content/uploads/2019/04/Criteo-CLV-Report-2019.pdf)** , many marketers struggle to leverage customer lifetime value to its full potential. 
...
![Chart shows erratic CLV over time](https://images.prismic.io/paddle/3ad1a2b5-6c16-4a57-8ac7-9248e5de193f_LTV+over+time.png?auto=format%2Ccompress&fit=max&w=1920)
...
![Chart shows a more steady CLV over time](https://images.prismic.io/paddle/a08fc8eb-70f3-4598-abe3-2fbdd374988d_LTV+over+time+%282%29.png?auto=format%2Ccompress&fit=max&w=1920)
...
### Optimize your [CLV/CAC ratio](https://www.paddle.com/resources/cac-ltv-ratio) to 3 or higher
...
Since customer CLV is a measure that combines how well you're monetizing (MRR) with how well you're retaining your customers ([MRR](https://www.paddle.com/resources/monthly-recurring-revenue) Churn), CLV can be used to benchmark success across different aspects of customer acquisition. Comparing LTV across channels, sales reps, marketing efforts, etc. will give you insight into which aspects you need to eliminate in your process and which you need to accelerate with more fuel.

### 

### Determine your best [customer personas](https://www.paddle.com/resources/buyer-personas)
...
CLV reflects [customer satisfaction](https://usersnap.com/blog/customer-satisfaction-survey) and ultimately encompasses how effective your retention is. The metric can be used to track the impact of different retention efforts, allowing you to advance your product org down a path that focuses on maximizing value through the product. 

### 

### [SaaS financial planning ](https://www.paddle.com/resources/saas-finance-metrics)and growth projections
...
Related[![Freemium business model illustration](https://images.prismic.io/paddle/af004c7f-33a1-4227-b2be-ec23cdcf7d1f_thumb-freemium-1.png?auto=format%2Ccompress&fit=max&w=1080)SaaS business model: Stages, pros & cons + essential tools to get ahead](/resources/saas-business-model)
...
Discounts can have the opposite effect that you want on customer LTV.[ Data shows SaaS discounting lowers SaaS LTV by over 30%](https://www.paddle.com/blog/saas-discounting-strategy)**.** This is broadly because the customers that are attracted to discounts tend to be users with higher price sensitivity (therefore a lower willingness to pay full price for a service) and higher rate of churn than your core user group would have at full price.
...
With Paddle's [automated billing system](https://www.paddle.com/billing), you can set up complex billing models that maximize customer lifetime value and track it overtime with our payment analytics. It's purpose-built for digital companies, and there's no need to build anything out yourself.
...
To help you stay on top of CLV in your business, we've put together a fact sheet with all the key takeaways from this guide. [**Download it now**](https://info.paddle.com/hubfs/clv-factsheet.pdf).
...
Customer lifetime value is more valuable as a metric when you calculate its ratio to customer acquisition cost (CAC). **[In the SaaS industry, the benchmark for CLV to CAC ratio is greater than 3:1](https://towardsdatascience.com/top-metrics-for-saas-companies-6a28a903a33f?gi=20186e856e1)**. 
...
Customer lifetime value can be used alongside other [**SaaS metrics**](https://www.paddle.com/resources/the-ultimate-saas-metrics-guide) to provide an all-round picture of your business situation.

One of the most important is [**churn rate**](https://www.paddle.com/blog/how-to-calculate-and-reduce-churn-rate). This refers to the percentage of your customers who don't renew their subscriptions. You can [analyse churn rate](/resources/customer-churn-analysis) to calculate the amount of revenue lost from those customers. 

[SaaS churn rate](https://www.paddle.com/blog/saas-churn-rate) is a critical metric because it can determine the long-term viability of your SaaS business. It also helps you see where you're going in the right direction and where you're going wrong. 
...
Selling SaaS? Paddle's purpose-built [SaaS billing software](https://www.paddle.com/billing) comes with customer retention tools like term optimization and dunning management, for free.
...
Taken together, CAC and CLV indicate the viability of your business model. In fact, [**customer acquisition cost**](https://www.paddle.com/resources/guide-to-customer-acquisition-cost) is so important that it’s been dubbed [**the ‘Startup Killer.’**](https://www.forentrepreneurs.com/startup-killer)
...
Related[![](https://images.prismic.io/paddle/91f472a9-874b-4983-9032-6f464aa9a1ed_abstract-heads.png?auto=format%2Ccompress&fit=max&w=1080)SaaS retention strategies to maximize growth](/resources/saas-retention-strategies)
...
Scalable pricing is vital to success in any SaaS business. The [pricing structure](https://www.paddle.com/resources/pricing-structure) should be created to scale either up or down capturing the smallest/cheapest customers, up to the largest, most valuable customers willing to pay more. The best way to do this is through what's known as a value metric (number of users, number of visits, depth of usage, etc.). Read more about [value metrics and choosing the right one here.](https://www.paddle.com/blog/value-metrics-pricing)
...
There are multiple ways to calculate CLV. To find it for a single customer, you just need to add up the total revenue per month and multiply it by the number of months they’ve been a customer. To find your business’ average CLV, you need to divide the average revenue per user by your company’s churn rate.
