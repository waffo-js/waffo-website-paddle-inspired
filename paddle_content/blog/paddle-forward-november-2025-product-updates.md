---
title: "Paddle Forward: Fall 2025 product updates"
description: "What's new at Paddle? Local payment methods, including Pix, UPI, BLIK and MB Way, 1-click payments, an upgraded MCP server with 80+ tools, and more."
source: "blog/paddle-forward-november-2025-product-updates.html"
---

# Paddle Forward: Fall 2025 product updates
...
[](https://x.com/intent/tweet?text=Paddle%20Forward%3A%20Fall%20'25%20product%20updates%20-%20https%3A%2F%2Fwww.paddle.com%2Fblog%2Fpaddle-forward-november-2025-product-updates%20via%20%40paddlehq)[](https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fwww.paddle.com%2Fblog%2Fpaddle-forward-november-2025-product-updates)[](https://www.linkedin.com/shareArticle?mini=true&url=https%3A%2F%2Fwww.paddle.com%2Fblog%2Fpaddle-forward-november-2025-product-updates&title=Paddle%20Forward%3A%20Fall%20'25%20product%20updates&source=)
...
**Watch the full event here or scroll down for the highlights.**
...
Paddle customers saved millions in involuntary churn in 2025 using [Retain](https://www.paddle.com/retain), but we’ve been focused on tackling voluntary churn too.
...
We’ve added several new payment methods across the globe:
  ...
  * Across Europe, [**BLIK**](https://developer.paddle.com/concepts/payment-methods/blik) and [**MB Way**](https://developer.paddle.com/concepts/payment-methods/mb-way) are now live for Billing customers.
  * In LATAM, [**Pix**](https://developer.paddle.com/concepts/payment-methods/pix) is available, meaning faster and easier access for customers in Brazil.
  * In APAC, Korean payment methods are live, with recurring support for [**Kakao Pay**](https://developer.paddle.com/concepts/payment-methods/korean/kakaopay) and [**Naver Pay**](https://developer.paddle.com/concepts/payment-methods/korean/naver-pay) coming later this year. And [**UPI** ](https://developer.paddle.com/concepts/payment-methods/upi)is rolling out to an early access cohort for your customers in India.
...
Simplifying your checkout can lift conversion rates by up to 35%. Your checkout experience is your biggest revenue lever, and our latest releases make it faster, leaner, and more flexible:
  ...
  * **Upsell Checkout** \- When deployed successfully, upsells can increase average order value by up to 30%. Our new [Upsell Checkout](https://developer.paddle.com/build/checkout/upsell-checkout) means customers can pay by card, PayPal, Apple Pay, and Google Pay with one-click for both one-time and subscription products, reducing the checkout footprint by 60%. This cuts cognitive load for buyers and helps them proceed quickly without feeling overloaded, helping you convert more without adding steps.
  * **Apple Pay Express Checkout** \- We’ve seen so many of you adopt the 1-click Apple Pay experience that we’re working on an Apple Pay Express Checkout that introduces a minimal, conversion-optimized flow using wallet credentials to remove unnecessary options and the need to enter extra details. Early access opens in Q4 - [sign up to register your interest](https://paddlecom.typeform.com/to/tBe1ZzoG) and be among the first to try.
...
This fall we’re introducing **Weekly Payouts** , faster access to your revenue, more flexibility to invest in growth, and better control over your cash flow. [Early access is open now](https://paddlecom.typeform.com/to/tBe1ZzoG), with rollout to selected customers over the next few months.
...
With the [Apple vs Epic ruling](https://www.paddle.com/blog/apple-vs-epic-app-store-changes) in May changing the game for how app companies monetize, we’ve deepened our collaborations with partners such as **RevenueCat, Adapty, Superwall, Zellify** , and others over the last few months. These partnerships give you more flexibility with managing subscriptions across platforms, improving retention, and optimizing monetization.

In 2026, we’ll continue to strengthen and evolve our partner integrations to make running and growing a mobile app business even more seamless. Interested in partnering with Paddle? [Find out more](https://www.paddle.com/partners) or [register your interest here](https://paddlecom.typeform.com/to/O5cmLQ0t).
...
[Complete our short survey](https://paddlecom.typeform.com/to/tBe1ZzoG) to have your say on the products we build next. We hope you continue to build, grow, and innovate and stay tuned for more updates in the next Paddle Forward.
