---
title: "2025 SaaS sales tax guide (United States and Rest of World)"
description: "Learn more about the sales tax regulations in your jurisdiction and how to manage sales tax compliance."
source: "blog/global-sales-taxes-for-software-companies-what-you-need-to-know-to-sell-internationally.html"
---

# 2025 SaaS sales tax guide (United States and Rest of World)

Sales tax on digital goods, software, and SaaS products varies by state and country. To avoid financial and legal consequences, use this guide to stay on top of sales tax laws.

![](https://images.prismic.io/paddle/28f11902-4696-48e1-8e3f-29a36189cb95_Siobhan+Onakomaiya.png?auto=compress%2Cformat&fit=max&w=1080)

Author

[Siobhan Onakomaiya](/resources/author/siobhan-onakomaiya)

Tax Specialist

Share

[](https://x.com/intent/tweet?text=2025%20SaaS%20sales%20tax%20guide%20\(United%20States%20and%20Rest%20of%20World\)%20-%20https%3A%2F%2Fwww.paddle.com%2Fblog%2Fsaas-sales-tax-state-wide-and-international%20via%20%40paddlehq)[](https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fwww.paddle.com%2Fblog%2Fsaas-sales-tax-state-wide-and-international)[](https://www.linkedin.com/shareArticle?mini=true&url=https%3A%2F%2Fwww.paddle.com%2Fblog%2Fsaas-sales-tax-state-wide-and-international&title=2025%20SaaS%20sales%20tax%20guide%20\(United%20States%20and%20Rest%20of%20World\)&source=)
...
_**Disclaimer** : The content in this article is up to date as of 1st October 2025. The below content is general information and should not be taken as legal tax advice. Please consult a tax law professional for expert advice if needed._
...
And trust us when we say, the last thing you want is some nasty tax penalties coming your way — [we would know](https://www.paddle.com/blog/we-got-a-300-vat-penalty-in-the-uae-heres-how-to-avoid-it). 
...
Below, we cover...
  ...
  * [Is SaaS subject to sales tax? ](#is-saas-subject-to-sales-tax)
  * [6 tax considerations when selling software ](#6-tax-considerations)
  * [Where do you need to pay sales tax? ](#where-do-you-need-to-pay-sales-tax)
  * [SaaS sales tax by state ](#saas-sales-tax-by-state)
  * [How to manage your sales tax compliance ](#How-to-manage-your-tax-compliance)
  * [SaaS sales tax FAQs ](#sales-tax-faqs)
...
**Our all-in-one billing platform features[sales tax software](https://www.paddle.com/billing/tax-and-compliance) that files and remits everything for you, so you can focus on growing your business.**

The US is a mighty fine example of how complicated just _one_ country can be when it comes to nailing your company’s sales tax obligations (let alone the rest of the countries you might be selling in). You’ve got some states that consider SaaS to be a service and some that don’t. You’ve got some states where services are taxable, and some states where services are not. And as if that wasn’t confusing enough, you’ve got some states that consider SaaS to be ‘tangible’ software, therefore making it a taxable product. And then there are all the varying tax rates and thresholds.

## 6 tax considerations when selling software

The lack of standardization in [software sales tax categories](https://www.paddle.com/blog/software-product-categories-sales-tax) across the world, and sometimes even across a single country, means there’s a lot to consider when it comes to selling SaaS products or services internationally. 

Here are the important areas of consideration for scaling your business across borders: 

  1. **Taxable goods** : what’s taxable and what’s eligible for tax exemption in specific locations
  2. **B2B vs. B2C:** B2C transactions are usually taxable depending on the territory you’re selling to. B2B is not always taxed, but in an increasing amount of jurisdictions it is. On top of that, some don’t distinguish between B2B and B2C transactions - for example, within the EU SaaS sales tax applies to only “a VAT-registered business”. This means you could have tax obligations to people you think are businesses, but from a tax perspective, they're considered consumers. 
  3. **Economic nexus threshold and tax rate:** the amount in sales you need to make before tax is due, and the amount you need to pay 
  4. **Audits:** what evidence you need of taxable vs. non-taxable sales, tax payments, any relevant tax credits, and how long you need to keep records for
  5. **Filing and remittance:** how often you need to file taxes (e.g., monthly, bi-monthly, quarterly, or annually) and the method of payment — not forgetting the required currency you need to pay in
  6. **Penalties for non-compliance** : these range from backdated payments with interest to additional fines and even criminal charges, where non-compliance is thought to be malicious


If you want to offload the operational work of sales tax compliance, consider using a [Merchant of Record](https://www.paddle.com/blog/what-is-merchant-of-record) like Paddle to take on tax liability on your behalf.

#### **Going global with your growth strategy?[Check out the updated guide](https://www.paddle.com/offers/selling-saas-globally-handbook?utm_campaign=ctas_fy2023&utm_content=content-cta) on global SaaS selling**

## Where do you need to pay SaaS sales tax?

We wish it was as simple as, "You need to pay this amount of sales tax in this country, and this amount in this country." It is not, _but_ we'll share some pointers to help you avoid the aforementioned hefty fines. 

For starters, we have a very useful [SaaS Sales Tax Index ](https://tax-agony.paddle.com/)for a run-through of sales tax jurisdictions around the world. Here’s some highlights below.
...
Due to a lack of a blanket tax system, [the US ](https://tax-agony.paddle.com/united-states)sees over 11,000 tax jurisdictions across its states, counties, and cities. With different rates in most states, and even different tax treatments for various types of software and digital goods, it can get confusing quickly. 
...
Arkansas| No| No  
California| No| No  
Colorado| No (state-level),__ varies per local city| No (state-level),__ varies per local city  
Connecticut| Yes| Yes  
Delaware| No| No  
Florida| No| No  
Georgia| No| No  
...
Countries in the [European Union](https://tax-agony.paddle.com/european-union) (EU) apply different VAT rates to software sales. Tax on cross-border B2C digital services can be accounted for via the VAT One-Stop Shop (OSS), previously known as VAT MOSS (Mini One-Stop Shop) in 2015.
...
Because of Brexit, the [United Kingdom ](https://tax-agony.paddle.com/united-kingdom)is no longer included in the VAT OSS system for sales into EU member states. That means, if you’re a UK business selling into the EU, you must register for VAT OSS in an EU member state or register for VAT in each member state your business sells digital services into. 
...
If you haven’t already, head to our [SaaS Sales Tax Index](https://tax-agony.paddle.com/). There, you’ll get a good sense of how high your chances are of owing tax in different countries, and get all the facts you need on how to best manage your tax compliance as a scaling software business.

### Sanctioned markets to be aware of

In accordance with anti-money laundering and international regulations, there's a list of [sanctioned or restricted markets ](https://www.paddle.com/support/countries-supported)that you should be aware of if you plan to sell internationally. Countries have been placed on this list for political or security reasons, so it’s more than likely these markets won’t be supported by payment providers, compliance tools, or merchants of record.

### Tax systems around the world

  1. **VAT OSS** – Introduced by the European Union in 2015, VAT OSS requires you to charge sales tax where the customer is based, as opposed to where a company is headquartered or operating (has a “physical nexus”). Since 2015, a number of countries outside Europe have introduced similar regulations.
...
You can also employ a [Merchant of Record](https://www.paddle.com/blog/what-is-merchant-of-record) like Paddle to handle tax compliance for your business. Your MoR will handle the headaches of payment processes and all the liability related to transactions, including sales tax compliance. A company can act as its own MoR, but the beauty of offloading tax compliance is that we take away payment and billing burdens, so you can go spend your time and resources on strategic projects and growth instead. 

Did you know that the App Store is a Merchant of Record? Paddle covers the same billing issues for [web payments](https://www.paddle.com/solutions/web-stores), while putting more flexibility and control in your hands.
...
Here’s more on [how Paddle handles sales tax ](https://www.paddle.com/taxes-fraud-compliance)and protects companies from tax fraud and other potential penalties. 

To find out more about how Paddle can help you: [**book a demo today.**](https://www.paddle.com/demo)
