---
title: "How does Sales Tax exemption work? - Help Center - Paddle"
description: "Sales tax is applied to invoices according to the customer&rsquo;s country and state or province, using our constantly updated tax logic. This works much lik..."
source: "help/manage/your-customers/how-does-sales-tax-exemption-work.html"
---

# How does Sales Tax exemption work? - Help Center - Paddle
...
How does Sales Tax exemption work?
...
If your customer has a **sales****tax exemption certificate** , Paddle can mark the customer as tax exempt and the tax amount will be revised accordingly. To do so, the customer will have to send the tax exemption documentation to our buyer support team via [assist@paddle.com](mailto:assist@paddle.com). Our buyer support team will then review the documentation and mark the customer tax exempt accordingly if the documentation is valid. 
...
To do so, the customer will have to send the tax exemption documentation to our buyer support team via [assist@paddle.com](mailto:assist@paddle.com). Our buyer support team will then review the documentation and issue the tax refund accordingly if the documentation is valid.
